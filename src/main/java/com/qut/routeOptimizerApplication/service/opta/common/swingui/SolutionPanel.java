...
package com.qut.routeOptimizerApplication.service.opta.common.swingui;
...
public abstract class SolutionPanel<Solution_> extends JPanel implements Scrollable {
    ...
    protected static final String USAGE_EXPLANATION_PATH = "/vehiclerouting/common/swingui/exampleUsageExplanation.png";
