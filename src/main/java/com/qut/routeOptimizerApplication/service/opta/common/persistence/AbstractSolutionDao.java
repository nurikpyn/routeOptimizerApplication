...
package com.qut.routeOptimizerApplication.service.opta.common.persistence;
...
public abstract class AbstractSolutionDao<Solution_> implements SolutionDao<Solution_> {
     ...
     */
   // public static final String DATA_DIR_SYSTEM_PROPERTY = "routeOptimizerApplication/";
    ...
    public AbstractSolutionDao(String dirName) {
        ...
        String dataDirPath = rot.datapath;
        dataDir = new File(dataDirPath, dirName);
        System.out.println(dataDirPath+""+dirName);
        if (!dataDir.exists()) {
            throw new IllegalStateException("The directory dataDir (" + dataDir.getAbsolutePath()
                    ...
                    + dataDirPath + " should be set properly.\n" +
